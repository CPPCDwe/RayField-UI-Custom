...
iRay  | Programming
WARNING! CODE FOR OFFICAL IN THE SITE https://github.com/jensonhirst/Rayfield/blob/main/source
No one uses this code for malicious or illicit purposes; it is entirely publicly available both our custom version and the original-so please use it responsibly.
]]
...
function ChangeTheme(ThemeName)
	...
	for _, TabPage in ipairs(Elements:GetChildren()) do
		if TabPage.ClassName == "ScrollingFrame" and TabPage.Name ~= "Template" then
			ApplyGlass(TabPage, Glass.Element)
		end
		for _, Element in ipairs(TabPage:GetChildren()) do
			if Element.ClassName == "Frame" and Element.Name ~= "Placeholder" and Element.Name ~= "SectionSpacing" and Element.Name ~= "SectionTitle"  then
				...
				ApplyGlass(Element, Glass.Element)
			end
		end
	end
...
local function CanUseGlass()
	if getgenv().SecureMode == nil then return true end
	return not getgenv().SecureMode
end

local function SetupGlassBlur()
	if not CanUseGlass() or GlassBlur then return end
	GlassBlur = Instance.new("DepthOfFieldEffect", game:GetService("Lighting"))
	GlassBlur.Name = "RayfieldGlassBlur"
	GlassBlur.Enabled = true
	GlassBlur.FarIntensity = 0
	GlassBlur.FocusDistance = 51.6
	GlassBlur.InFocusRadius = 50
	GlassBlur.NearIntensity = 1
end

local function EnsureBlurModule(frame)
	local blur = frame:FindFirstChild("BlurModule")
	if not blur then
		blur = Instance.new("Frame")
		blur.Name = "BlurModule"
...
local function BindGlass(frame)
	if not frame then return end
	if not (frame:IsA("Frame") or frame:IsA("ScrollingFrame")) then return end
...
local function CleanupGlass()
	for _, blur in ipairs(GlassFrames) do
		pcall(function()
			neon:UnbindFrame(blur)
		end)
	end
	GlassFrames = {}
	if GlassBlur then
...
function Unhide()
	...
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = Glass.Main}):Play()
	TweenService:Create(Main.Topbar, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = Glass.Topbar}):Play()
	TweenService:Create(Main.Topbar.Divider, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = 0}):Play()
	TweenService:Create(Main.Topbar.CornerRepair, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = Glass.Topbar}):Play()
				...
				if element.ClassName == "Frame" then
					if element.Name ~= "SectionSpacing" and element.Name ~= "Placeholder" then
						if element.Name == "SectionTitle" then
							...
							TweenService:Create(element, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundTransparency = Glass.Element}):Play()
...
function Maximise()
	...
	TweenService:Create(Topbar.CornerRepair, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = Glass.Topbar}):Play()
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.KeySystem then
		...
		if not Passthrough then
			...
			TweenService:Create(KeyMain, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundTransparency = Glass.Main}):Play()
			...
			TweenService:Create(KeyMain.Input, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {BackgroundTransparency = Glass.Element}):Play()
	...
	wait(0.5)
	TweenService:Create(Main, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = Glass.Main}):Play()
	...
	function Window:CreateTab(Name,Image)
		...
		function Tab:CreateButton(ButtonSettings)
			...
			TweenService:Create(Button, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = Glass.Element}):Play()
		...
		function Tab:CreateColorPicker(ColorPickerSettings) -- by Throit
			...
			ColorPicker.Interact.MouseButton1Down:Connect(function()
				if not opened then
					...
					TweenService:Create(Background, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundTransparency = Glass.Element}):Play()
				else
					opened = false
		...
		function Tab:CreateLabel(LabelText)
			...
			TweenService:Create(Label, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = Glass.Element}):Play()
		...
		function Tab:CreateParagraph(ParagraphSettings)
			...
			TweenService:Create(Paragraph, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = Glass.Element}):Play()
		...
		function Tab:CreateInput(InputSettings)
			...
			TweenService:Create(Input, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = Glass.Element}):Play()
		...
		function Tab:CreateDropdown(DropdownSettings)
			...
			TweenService:Create(Dropdown, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = Glass.Element}):Play()
			...
			Dropdown.Interact.MouseButton1Click:Connect(function()
				...
				if Dropdown.List.Visible then
					...
					for _, DropdownOpt in ipairs(Dropdown.List:GetChildren()) do
						if DropdownOpt.ClassName == "Frame" and DropdownOpt.Name ~= "Placeholder" then
							TweenService:Create(DropdownOpt, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundTransparency = Glass.Element}):Play()
		...
		function Tab:CreateKeybind(KeybindSettings)
			...
			TweenService:Create(Keybind, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = Glass.Element}):Play()
		...
		function Tab:CreateToggle(ToggleSettings)
			...
			TweenService:Create(Toggle, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = Glass.Element}):Play()
		...
		function Tab:CreateSlider(SliderSettings)
			...
			TweenService:Create(Slider, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = Glass.Element}):Play()
	...
	wait(0.5)
	Topbar.Visible = true
	TweenService:Create(Topbar, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = Glass.Topbar}):Play()
	TweenService:Create(Topbar.CornerRepair, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = Glass.Topbar}):Play()
	wait(0.1)
